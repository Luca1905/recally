...
const deck = {
	...
	description:
		"Essential Spanish vocabulary for beginners to intermediate learners.",
	cardCount: 120,
	dueCount: 12,
		...
		<div className="container mx-auto p-6">
			...
			>
				<div className="mb-6 flex items-center justify-between">
					<h2 className="font-bold text-xl">Cards ({deck.cards.length})</h2>
					...
					{deck.cards.map((card, index) => (
						<motion.div
							...
							className={`group flex flex-wrap items-center gap-4 border-foreground/10 border-b p-4 transition-colors hover:bg-primary/5 md:flex-nowrap ${
								index === deck.cards.length - 1 ? "border-b-0" : ""
							}`}
							initial={{ opacity: 0, y: 20 }}
							animate={{ opacity: 1, y: 0 }}
